...
/* AI Loader */
@keyframes pulse-bar { 0%{width:0%} 60%{width:85%} 100%{width:95%} }
@keyframes float-plane { 0%,100%{transform:translateY(0) rotate(-5deg)} 50%{transform:translateY(-8px) rotate(5deg)} }
@keyframes fade-step { 0%{opacity:0.3} 50%{opacity:1} 100%{opacity:0.3} }
...
.ai-loader-fill {
    height: 100%;
    background: linear-gradient(90deg, #d4622a, #f0a500);
    border-radius: 4px;
    animation: pulse-bar 8s ease-in-out forwards;
}
.ai-loader-steps {
    display: flex;
...
.ai-step {
    ...
    border-radius: 20px;
    border: 1px solid #2d2d44;
    animation: fade-step 2s ease-in-out infinite;
}
.ai-step:nth-child(2) { animation-delay: 0.4s; }
.ai-step:nth-child(3) { animation-delay: 0.8s; }
.ai-step:nth-child(4) { animation-delay: 1.2s; }
...
<div style='margin-bottom:2rem'>
    <div style='font-size:0.72rem;text-transform:uppercase;letter-spacing:0.14em;color:#d4622a;font-weight:600'>Agentic AI</div>
    <h1 style='font-size:2.6rem;margin:0.3rem 0 0;line-height:1.15;color:#f5f0e8;font-family:Playfair Display,serif;font-weight:900'>
        Plan Your Perfect<br>Indian Journey
    </h1>
    <p style='color:#a89f96;margin-top:0.6rem;font-size:0.95rem;line-height:1.6'>
...
if plan_btn:
    ...
    <div class='ai-loader'>
        ...
        <div class='ai-loader-title'>Planning your trip to {destination}</div>
        <div class='ai-loader-sub'>Searching flights · Hotels · Weather · Attractions</div>
        <div class='ai-loader-bar'><div class='ai-loader-fill'></div></div>
        <div class='ai-loader-steps'>
            <span class='ai-step'>✈ Flights</span>
            <span class='ai-step'>🏨 Hotels</span>
            <span class='ai-step'>🌤 Weather</span>
            <span class='ai-step'>📍 Places</span>
            <span class='ai-step'>💰 Budget</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
if output_text:
    ...
    <div style='font-family:Playfair Display,serif;font-size:1.4rem;color:#f5f0e8;margin-bottom:0.5rem;font-weight:700'>Ready to plan your trip?</div>
    <div style='font-size:0.9rem;color:#a89f96;line-height:1.6'>Set your preferences in the sidebar and click <b style='color:#d4622a'>PLAN MY TRIP →</b></div>
    </div>""", unsafe_allow_html=True)
